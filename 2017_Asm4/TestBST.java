...
public class TestBST {
	...
	public static void main(String[] args) {
		...
		try {
			...
			else System.out.println("Test 4 failed1");
		}
		catch(Exception e) {
			e.printStackTrace();
			System.out.println("Test 4 failed2");
		}
		...
		try {
			...
			else System.out.println("Test 6 failed: wrong res");
		}
		catch (Exception e) {
		...
		try {
			...
			else System.out.println("Test 7 failed1");
		}
		catch (Exception e) {
			System.out.println("Test 7 failed2");
		}
		...
		try {
			...
			else System.out.println("Test 15 failed1");
		}
		catch (Exception e) {
			System.out.println("Test 15 failed2");
		}
